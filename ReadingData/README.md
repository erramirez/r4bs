...
3.  Set the working directory to the r4bs repo
...
p01_readrformatskip <- read_csv("https://raw.githubusercontent.com/erramirez/r4bs/master/ExampleData/FitbitDailyData/p01_dailyActivity.csv",
                            col_types = cols(
                              ActivityDate = col_date("%m/%d/%y"),
